...
public class Online extends baseactivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtTalkAudio.setVisibility(mBtTalkAudio.INVISIBLE);

        mBtTalkVideo.setEnabled(false);
        mBtTalkVideo.setVisibility(mBtTalkVideo.INVISIBLE);

        mBtTalkDoodle.setEnabled(false);
        mBtTalkDoodle.setVisibility(mBtTalkDoodle.INVISIBLE);
        ...
        mBtTalkDoodle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mEtTalkNumber.getText().toString().trim()==null||mEtTalkNumber.getText().toString().trim().length()<4){
                    Toast.makeText(Online.this,"输入好友帐号或选择一个好友，进行邀请K歌！",Toast.LENGTH_SHORT).show();
                }else {
                        ...
                        mySpinner.setOnItemSelectedListener(new  Spinner.OnItemSelectedListener(){
                                    public  void  onItemSelected(AdapterView<?> arg0, View  arg1, int  arg2, long  arg3)  {
                                        ...
                                        if (fg==false){
                                            ...
                                            mEtTalkNumber.setText(adapter.getItem(arg2).toString().trim().split(":")[1]);
                                        }
            ...
            sMtcCallTalkingReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    try {
                        ...
                        Intent intent1=new Intent(Online.this, RecordSong.class);
    ...
    WebService http1=new WebService(new RequestFunc() {
        ...
        public void Func() {
            ...
            if (http1.Result!= null) {
                ...
                Toast.makeText(Online.this, "歌友信息获取失败！" + http1.Result, Toast.LENGTH_SHORT).show();
            }
        }
    });
        ...
        public void Func() {
            if (http.Result != null) {
                if (http.Result.equals("true")) {
                    Toast.makeText(Online.this, "发送成功" + http.Result, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Online.this, "发送失败! 请检查网络是否异常，歌友帐号是否正确，稍后重试！\n"+http.Result, Toast.LENGTH_SHORT).show();
                }
            }
        }
    });
